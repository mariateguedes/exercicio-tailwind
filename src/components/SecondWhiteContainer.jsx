            ...
            {data.map((item) => (
                <div className="flex gap-8 mb-10">
                    <div className="grid content-start gap-1.5">
                        ...
                        <p className="text-primary text-xl font-black">{item.title}</p>
                        <p className="text-primary-base-low text-sm tracking-wide">{item.text}</p>
                    </div>
        ...
        <div className="basis-1/3">
            ...
            {data2.map((item) => (
                    <div className='p-2 pb-4'>
                        <p className="text-data-primary-base-low">{item.date}</p>
                        <p className="text-primary text-lg font-extrabold tracking-wide">{item.title}</p>
                    </div>
            )
            )}
            </div>
